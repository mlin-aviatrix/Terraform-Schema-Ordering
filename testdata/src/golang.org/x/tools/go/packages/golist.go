...
type jsonPackage struct {
	...
	XTestGoFiles      []string
	XTestImports      []string
	ForTest           string // q in a "basic [q.test]" package, else ""
	DepOnly           bool
...
func (state *golistState) createDriverResponse(words ...string) (*driverResponse, error) {
	...
	//
	// 	"basic"			-- importable package or main (command)
	// 	"q.test"		-- q's test executable
	// 	"basic [q.test]"		-- variant of basic as built for q's test executable
	// 	"q_test [q.test]"	-- q's external test package
	//
	// The packages basic that are built differently for a test q.test
