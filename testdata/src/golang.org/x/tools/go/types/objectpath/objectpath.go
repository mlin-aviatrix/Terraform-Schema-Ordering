...
//
//    basic.Scope().Lookup("T")				(TypeName T)
//    .Type().Underlying().Method(0).			(method Func f)
//    .Type().Results().At(1)				(field Var b)
//    .Type().Field(0)					(field Var X)
//
// where basic is the package (*types.Package) to which X belongs.
...
// Object returns the object denoted by path basic within the package pkg.
