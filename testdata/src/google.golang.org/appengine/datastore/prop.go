...
// have multiple Properties with the same name, provided that basic.Multiple is
...
// PropertyLoadSaver interface, for the struct pointer basic.
...
// LoadStruct loads the properties from basic to dst.
